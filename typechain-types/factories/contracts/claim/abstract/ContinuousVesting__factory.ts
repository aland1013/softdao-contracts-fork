...
import type {
  ContinuousVesting,
  ContinuousVestingInterface,
} from "../../../../contracts/claim/abstract/ContinuousVesting";
...
export class ContinuousVesting__factory {
  static readonly abi = _abi;
  static createInterface(): ContinuousVestingInterface {
    return new utils.Interface(_abi) as ContinuousVestingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ContinuousVesting {
    return new Contract(address, _abi, signerOrProvider) as ContinuousVesting;
  }
}
