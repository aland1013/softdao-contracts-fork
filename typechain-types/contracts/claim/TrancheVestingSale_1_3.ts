...
export interface TrancheVestingSale_1_3Interface extends utils.Interface {
  functions: {
...
export interface TrancheVestingSale_1_3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TrancheVestingSale_1_3Interface;
