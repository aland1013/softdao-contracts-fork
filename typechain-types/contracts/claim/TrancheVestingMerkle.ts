...
export interface TrancheVestingMerkleInterface extends utils.Interface {
  functions: {
...
export interface TrancheVestingMerkle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TrancheVestingMerkleInterface;
