...
export interface PriceTierVestingMerkleInterface extends utils.Interface {
  functions: {
...
export interface PriceTierVestingMerkle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceTierVestingMerkleInterface;
