...
export interface TrancheVestingSale_2_0Interface extends utils.Interface {
  functions: {
...
export interface TrancheVestingSale_2_0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TrancheVestingSale_2_0Interface;
