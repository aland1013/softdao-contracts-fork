...
export interface AdvancedDistributorInterface extends utils.Interface {
  functions: {
...
export interface AdvancedDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdvancedDistributorInterface;
