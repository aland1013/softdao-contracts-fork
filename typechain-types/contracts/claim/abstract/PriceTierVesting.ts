...
export interface PriceTierVestingInterface extends utils.Interface {
  functions: {
...
export interface PriceTierVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceTierVestingInterface;
