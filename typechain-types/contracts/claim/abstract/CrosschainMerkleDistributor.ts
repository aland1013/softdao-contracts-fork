...
export interface CrosschainMerkleDistributorInterface extends utils.Interface {
  functions: {
    ...
    "claimByMerkleProof(address,uint256,bytes32[])": FunctionFragment;
    "claimBySignature(address,uint32,address,uint32,uint256,bytes,bytes32[])": FunctionFragment;
    ...
    "initializeDistributionRecord(uint32,address,uint256,bytes32[])": FunctionFragment;
    "name()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "claimByMerkleProof",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "claimBySignature",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
...
export interface CrosschainMerkleDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrosschainMerkleDistributorInterface;
  ...
  functions: {
    ...
    claimBySignature(
      ...
      _recipientDomain: PromiseOrValue<BigNumberish>,
      _beneficiary: PromiseOrValue<string>,
      _beneficiaryDomain: PromiseOrValue<BigNumberish>,
      _total: PromiseOrValue<BigNumberish>,
