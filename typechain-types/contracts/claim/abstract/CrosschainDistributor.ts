...
export interface CrosschainDistributorInterface extends utils.Interface {
  functions: {
...
export interface CrosschainDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrosschainDistributorInterface;
