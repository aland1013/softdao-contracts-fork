...
export interface ContinuousVestingInterface extends utils.Interface {
  functions: {
...
export interface ContinuousVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ContinuousVestingInterface;
