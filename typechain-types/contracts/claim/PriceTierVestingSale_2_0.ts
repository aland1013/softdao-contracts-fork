...
export interface PriceTierVestingSale_2_0Interface extends utils.Interface {
  functions: {
    ...
    "getPurchasedAmount(address)": FunctionFragment;
    ...
    "initializeDistributionRecord(address)": FunctionFragment;
    "name()": FunctionFragment;
    ...
    "soldTokenDecimals()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPurchasedAmount",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "soldTokenDecimals",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PriceTierVestingSale_2_0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PriceTierVestingSale_2_0Interface;
  ...
  functions: {
    ...
    soldTokenDecimals(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    soldTokenDecimals(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    soldTokenDecimals(overrides?: CallOverrides): Promise<PopulatedTransaction>;
