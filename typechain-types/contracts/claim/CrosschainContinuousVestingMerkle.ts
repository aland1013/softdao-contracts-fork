...
export interface CrosschainContinuousVestingMerkleInterface
...
export interface CrosschainContinuousVestingMerkle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrosschainContinuousVestingMerkleInterface;
