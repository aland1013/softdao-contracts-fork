...
export interface GovernorMultiSourceUpgradeableInterface
...
export interface GovernorMultiSourceUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorMultiSourceUpgradeableInterface;
