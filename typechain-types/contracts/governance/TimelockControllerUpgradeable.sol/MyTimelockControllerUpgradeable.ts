...
export interface MyTimelockControllerUpgradeableInterface
...
export interface MyTimelockControllerUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyTimelockControllerUpgradeableInterface;
