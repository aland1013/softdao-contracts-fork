...
export interface ICrosschainBaseInterface extends utils.Interface {
  functions: {
...
export interface ICrosschainBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICrosschainBaseInterface;
